package com.halfsummer.generator.toolkit;

import com.halfsummer.generator.pagination.Pagination;
import com.halfsummer.generator.base.AbstractDataBaseUtil;
...
public class MysqlDataBaseUtil extends AbstractDataBaseUtil {
    ...
    public Pagination<TableInfo> getTables(Pagination page, String schemaName, String tableName, String tableDescribe) {
        ...
        try {
            ...
            // 打印语句,方便排错
            System.out.println("==>  print xml: " + countSql);
            ...
            if(count > 0) {
                // 打印语句,方便排错
                System.out.println("==>  print xml: " + selectSql);
    ...
    public List<FieldInfo> getFields(String schemaName, String tableName) {
        ...
        try {
            ...
            // 打印sql
            System.out.println("==>  print xml: " + sql);
